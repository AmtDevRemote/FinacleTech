...
<td width="100%" height="12" class="content">
	<%
	System.out.println(request.getAttribute("imserviceperformanceList"));
	...
	<logic:present name="imserviceperformanceList" scope="request">
		<logic:iterate id="userDetails" name="imserviceperformanceList">
			<%
				num=num+1 ;
			%>
		</logic:iterate>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td class="framemenu_date" colspan="3" align="Left">&nbsp;IM Service Performance Report</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			<table border="0" cellspacing="1" width="100%">
				<tr class="content">
				  ...
				  <td width="16%" align="center" bgcolor="#FFB502">Average Throughput (inbound) per second</td>
				  <td width="16%" align="center" bgcolor="#FFB502">Average Throughput (outbound)per second</td>
				</tr>
				<%int increment=0;%>
				<logic:present name="imserviceperformanceList" scope="request">
				<logic:iterate id="userDetails" name="imserviceperformanceList">
				 <tr class="content">
				   ...
				   <td width="15%"  bgcolor="white" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" bordercolor="#C0C0C0">
				   &nbsp;<bean:write name="userDetails" property="inbond"/></td>
				   <td width="15%"  bgcolor="white" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" bordercolor="#C0C0C0">
				   &nbsp;<bean:write name="userDetails" property="outbond"/></td>
            ...
            <input type=button value="Save As" onclick="saveAsMe('IM service performance Report.xls');">
					</td>
				</tr>
            </table>
		</td>
