...
<script type="text/javascript" language="JavaScript">
   	function submitDelete()
	{
		...
		if (!form.enumId)
			return false;
		if (form.enumId.length)
			max = form.enumId.length;
		for(var i=1;i<=max;i++){
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
	<tr>
		...
		<td style="background-color:#005977;"></td>
		<td width="6"><img src="images/menu-bg-top-right.gif" alt="" width="6" height="6" border="0"></td>
		<td rowspan="4"><img src="images/spacer.gif" alt="" width="7" border="0"></td>
	</tr>
	<tr>
		<td class="framemenu_date" colspan="3">&nbsp;Enumerations</td>
	</tr>
	<tr>
		...
		<td bgcolor="#E2E2E2" valign="top" height="100%" width="100%">
			...
			<tr>
				<td width="100%"  height="100%" align="left">
					<iframe name="groupList" src="action/enumeration" width="100%" height="100%" frameborder="0" marginwidth="0" marginheight="0"></iframe>
				</td>
			</tr>
			<tr>
				<td align="left">
					<input type="button" value="&nbsp;Add&nbsp;" name="B3" class="logout_box" href="#" onClick="MM_openBrWindow('action/enumeration?action=addEnum','newList', 280, 430)">&nbsp;
