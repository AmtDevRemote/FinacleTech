...
{   
    alert("Select date only in starting date");
	document.form.month.disabled = disableIt;
	document.form.year.disabled = disableIt;
}
function checkField()
{
...
%>
<html:form method="post"  action="/ServiceUsageDetailsAction" onsubmit="">
<table>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="framemenu_date" colspan="3">&nbsp;&nbsp;Service Usage Performance Report&nbsp;&nbsp;</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			...
			<tr>
				<td width="150" class="content" height="23">Select Report Type<font color="#FF0000"></font>
				<td class="content" height="23"><FONT face=arial size=2><INPUT TYPE=RADIO NAME="pizzasize" VALUE="Daily" onclick="disable(this.checked)">Daily
				<INPUT TYPE=RADIO NAME="pizzasize" VALUE="Duration" CHECKED>Duration 
				</td>
				<td  height="23">&nbsp;</td>
			</tr>
			<tr>
				<td width="150" class="content" height="23">Select the Starting Date<font color="#FF0000">*</font>
			...
			<tr>
				<td width="150" class="content" height="23">Select the End Date<font color="#FF0000">*</font>
				<td class="content" height="23"><FONT face=arial size=2>
				<SELECT name=day1 width="10">
				<%
				...
				{
				%>
				<option value=<%=i%> <%=(i==day1?" selected":"") %>><%=i %></option>
				<%
				}
				%>
				</SELECT> 
