...
<body>
<%
request.getAttribute("AverageIMsizeBeanList");
...
%>
<html:form method="post"  action="/AverageIMSize1Action" onsubmit="">
<table>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="framemenu" valign="top">
			...
			<tr>
				<td width="150" class="content" height="23">Select UserID<font color="#FF0000">*</font>
				<td class="content" height="23"><select name="UserID" ><logic:present name="AverageIMsizeBeanList" scope="request">
				<logic:iterate id="userDetails" name="AverageIMsizeBeanList">
				   
				   <option value=<bean:write name="userDetails" property="username"/>><bean:write name="userDetails" property="user"/></option>
