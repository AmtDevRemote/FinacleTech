...
<td width="100%" height="12" class="content">
	<%
	System.out.println(request.getAttribute("IMSendReceiveList"));
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td class="framemenu_date" colspan="3" align="Left">&nbsp;IM Sent and Received by hour Report</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			<table border="0" cellspacing="1" width="100%">
				<tr class="content">
				  ...
				  <td width="16%" align="center" bgcolor="#FFB502">No. of IM Sent </td>
				  <td width="16%" align="center" bgcolor="#FFB502">No. of IM Received</td>
				</tr>
				<%int increment=0;%>
				<logic:present name="IMSendReceiveList" scope="request">
				<logic:iterate id="userDetails" name="IMSendReceiveList">
            ...
            <input type=button value="Save As" onclick="saveAsMe('IMSentand Received by hour Report.xls');">
					</td>
				</tr>
            </table>
		</td>
