...
<td width="100%" height="12" class="content">
	<%
	System.out.println(request.getAttribute("ActiveUserList"));
	...
	<logic:present name="IMSendReceiveList" scope="request">
		<logic:iterate id="userDetails" name="IMSendReceiveList">
			<%
				num=num+1 ;
			%>
		</logic:iterate>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td class="framemenu_date" colspan="3" align="Left">&nbsp;Active Users by hour Report</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			<table border="0" cellspacing="1" width="100%">
				...
				<tr class="content">
				  ...
				  <td width="16%" align="center" bgcolor="#FFB502">Hours</td>
				  <td width="16%" align="center" bgcolor="#FFB502">Active Users(Added In Current Hour)</td>
				  <td width="17%" align="center" bgcolor="#FFB502">Number(Total Active Users On Server)</td>
				 
				</tr>
				<%int increment=0;%>
				<logic:present name="ActiveUserList" scope="request">
				<logic:iterate id="userDetails" name="ActiveUserList">
				 <tr class="content">
				   ...
				   <td width="15%"  bgcolor="white" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" bordercolor="#C0C0C0">
				   &nbsp;<bean:write name="userDetails" property="activeuser"/></td>
				   <td width="15%"  bgcolor="white" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" bordercolor="#C0C0C0">
				   &nbsp;<bean:write name="userDetails" property="number"/></td>
				   	</tr>
				</logic:iterate>
				</logic:present>
            ...
            <input type=button value="Save As" onclick="saveAsMe('Active User Report.xls');">
					</td>
				</tr>
            </table>
		</td>
