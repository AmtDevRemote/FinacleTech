...
<td width="100%" height="12" class="content">
	<%
	System.out.println(request.getAttribute("RequestbyHourList"));
	...
	<logic:present name="RequestbyHourList" scope="request">
		<logic:iterate id="userDetails" name="RequestbyHourList">
			<%
				num=num+1 ;
			%>
		</logic:iterate>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td class="framemenu_date" colspan="3" align="Left">&nbsp;Requests by hour Report</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			<table border="0" cellspacing="1" width="100%">
				<tr class="content">
				  ...
				  <td width="16%" align="center" bgcolor="#FFB502">Result (Pass/Fail)</td>
				  <td width="16%" align="center" bgcolor="#FFB502">Reason/Remark</td>
				  <td width="16%" align="center" bgcolor="#FFB502">User</td>
				</tr>
				<%int increment=0;%>
				<logic:present name="RequestbyHourList" scope="request">
				<logic:iterate id="userDetails" name="RequestbyHourList">
				 <tr class="content">
				   ...
				   <td width="15%"  bgcolor="white" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" bordercolor="#C0C0C0">
				   &nbsp;<bean:write name="userDetails" property="remark"/></td>
				   <td width="15%"  bgcolor="white" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" bordercolor="#C0C0C0">
				   &nbsp;<bean:write name="userDetails" property="user"/></td>
				 	</tr>
				</logic:iterate>
				</logic:present>
            ...
            <input type=button value="Save As" onclick="saveAsMe('Requests by hour Report.xls');">
					</td>
				</tr>
            </table>
		</td>
