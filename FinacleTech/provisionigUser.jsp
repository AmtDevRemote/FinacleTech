...
<body>
<html:form method="post" action="/provisionigUserAction" onsubmit="return checkField()">
<table>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="framemenu_date" colspan="3">Add  Provisioning User</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			...
			<tr>
			  ...
			  <tr>
				...
				<td class="framemenu_item" align="right"><input type="submit" name="B3">&nbsp;<input type="reset" value="Reset" name="B2"></td>		
				</tr>
			</table>
		</td>
