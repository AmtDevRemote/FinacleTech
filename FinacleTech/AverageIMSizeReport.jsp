...
<td width="100%" height="12" class="content">
	<%
	System.out.println(request.getAttribute("AverageimList"));
	...
	<logic:present name="AverageimList" scope="request">
		<logic:iterate id="userDetails" name="AverageimList">
			<%
				num=num+1 ;
			%>
		</logic:iterate>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td class="framemenu_date" colspan="3" align="Left">&nbsp;Average IM size Report</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			<table border="0" cellspacing="1" width="100%">
				<tr class="content">
				  ...
				  <td width="16%" align="center" bgcolor="#FFB502">Average IM Size (Sent)(In Bytes)</td>
				  <td width="16%" align="center" bgcolor="#FFB502">Average IM Size (Received)(In Bytes)</td>
				...
				<logic:iterate id="userDetails" name="AverageimList">
				 <tr class="content">
				   ...
				   <td width="15%"  bgcolor="white" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" bordercolor="#C0C0C0">
				   &nbsp;<bean:write name="userDetails" property="imsend"/></td>
				   <td width="15%"  bgcolor="white" style="border-style: solid; border-width: 1; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1" bordercolor="#C0C0C0">
            ...
            <input type=button value="Save As" onclick="saveAsMe('Average IM size Report.xls');">
					</td>
				</tr>
            </table>
		</td>
