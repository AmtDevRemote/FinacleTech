...
%>
<html:form method="post"  action="/CommonRequestResponceSentReceivedAttemptsReportAction" onsubmit="">
<table>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="framemenu_date" colspan="3">&nbsp;&nbsp;Request Response Report&nbsp;&nbsp;</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			...
			<tr>
				<td width="150" class="content" height="23">Select Request Type<font color="#FF0000">*</font>
				<td class="content" height="23"><select name="report">
						<option value="-1">Select</option>
						<option value="SubscribePresence-Request">Subscription</option>
						<option value="UnsubscribePresence-Request">Unsubscription</option>
						<option value="PresenceAuth-User">Presence Authorization</option>
						<option value="PresenceNotification-Request">Notification Presence</option>
						</select></td>
				<td  height="23">&nbsp;</td>
			</tr>
			<tr>
				<td width="150" class="content" height="23">Select the Report Type<font color="#FF0000">*</font>
				<td class="content" height="23"><select name="RType" >
					<option value="-1">Select Report Type
					<option value="srattempt">Sent / Received Attempts Report</option>
					<option value="srfratio">Sent/Received Failure Ratios Report</option>
					</select></td>
				<td  height="23">&nbsp;</td>
			</tr>
