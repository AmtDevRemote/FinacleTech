...
<td width="100%" height="12" class="content">
	<%
	System.out.println(request.getAttribute("UsersSubscribedtoPresenceServiceList"));
	...
	<logic:present name="UsersSubscribedtoPresenceServiceList" scope="request">
		<logic:iterate id="userDetails" name="UsersSubscribedtoPresenceServiceList">
			<%
				num=num+1 ;
			%>
		</logic:iterate>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
		<td class="framemenu_date" colspan="3" align="Left">&nbsp;Users Subscribed to Presence Service Report&nbsp; </td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			<table border="0" cellspacing="1" width="100%">
				<tr class="content">
				  ...
				  <td width="16%" align="center" bgcolor="#FFB502">Subscribed Users</td>
            ...
            <input type=button value="Save As" onclick="saveAsMe('Users Subscribed to Presence Service Report.xls');">
					</td>
				</tr>
            </table>
		</td>
