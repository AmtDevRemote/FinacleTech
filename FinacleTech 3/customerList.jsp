...
<form name="customerform" method="post" action="../action/customerDisplay?action=updateCustomerList">
...
<tr class="content">
	...
	<table border="0"  cellspacing="1" cellpading="2" width="100%" bgcolor="#E2E2E2">
		...
		<tr>
		<td colspan="2" align="right"><pagination-tag:pager title="yes" start="<%=start%>" 	range="<%=range%>" results="<%=results%>"  action="<%=action%>" styleClass="page" /></td><td colspan="3" align="left">
