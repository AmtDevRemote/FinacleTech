...
<script language="JavaScript" src="calendar2.js"></script>
   ...
   <script>
    function call()
    {
    window.document.forms.action="trapUser.jsp";
...
<body>
<form method="post"  action="../action/TrapUserAction?option=save" onsubmit="" name="frmPeak">
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td class="framemenu_date" colspan="3">Trap User</td>
	</tr>
	<tr>
		...
		<td class="framemenu" valign="top">
			...
			<tr>
			  ...
			  <tr>
				...
				<td height="23">
				<div id="INPUT" ><input type="text" name="startDate" >&nbsp;<a href="javascript:cal3.popup();"><img src="../cal.gif"></a></div>
			  ...
			  <tr>
				...
				<td height="23">
				<div id="INPUT" ><input type="text" name="endDate">&nbsp;<a href="javascript:cal4.popup();"><img src="../cal.gif"></a></div>
				<td  height="23">&nbsp;</td>
			  </tr>
				...
				<td height="23" width="1">
					<input type="checkbox" name="blockIM"  align="right" value="1" class="content" style="border: 1px solid #808080; padding-left: 1; padding-right: 1; padding-top: 1; padding-bottom: 1; "/>
				</td>
				<td height="23" Class="content">IM</td>
				</tr>
				<tr>
				
				<td height="23" width="1">
					<input type="checkbox" name="blockSubscription" align="right" value="1" class="content" style="border: 1px solid #808080; padding-left: 1; padding-right: 1; padding-top: 1; padding-bottom: 1; "/>
				</td>
				<td height="23" Class="content">All</td>
				<td  height="23">&nbsp;</td>
			  	</tr>
