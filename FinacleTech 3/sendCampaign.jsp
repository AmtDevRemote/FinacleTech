...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
		...
		<td bgcolor="#E2E2E2" valign="top" width="100%">
			...
			<tr>
				<td class="content" rowspan=2 width="400">
					<html:textarea name="distributionListForm" property="groupMessage" value="<%=messageText%>" rows="3" cols="60" styleClass="content" style="border: 1px solid #808080; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1;" />
				</td>
			...
			<tr>
				<td class="content" align="left" valign="bottom"><a href="../newcustomer.htm" target="groupList" class="style1">New Customer</a>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
				<td width="100%"  height="100%" colspan="6">
					<iframe marginwidth="2" name="groupList" src="../action/distributionList" width="100%" height="100%" frameborder="0" marginwidth="0" marginheight="0"></iframe>
				</td>
	</tr>
